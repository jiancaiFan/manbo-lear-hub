package cn.heartbath.mambo_lear_hub.manbolearhub.constants
...
internal object CommonColors {
    ...
    val Placeholder = Color(0xFFE5E7EB)

    val Title = Color(0xFF111827)
    val Summary = Color(0xFF4B5563)
    val Meta = Color(0xFF6B7280)

    val PrimaryBlue = Color(0xFF2563EB)
    val PrimaryBlueLightBg = Color(0xFFEFF6FF)

    val DividerSoft = Color(0xFFF1F5F9)
    val IconHint = Color(0xFFD1D5DB)

    val LeftTextNormal = Color(0xFF9CA3AF)
